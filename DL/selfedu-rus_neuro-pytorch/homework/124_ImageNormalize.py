...
def _generate_img(_H, _W, _Hc, _Wc, _x, _y, _circle, _tr):
...
# создайте объект класса ImageNormalize
...
# вычислите величину потерь, используя функцию loss_func = nn.MSELoss()
loss_func = nn.MSELoss()
Q = loss_func(predict, data_y.float())
