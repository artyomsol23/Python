...
x, h = model(noise.view(1, total, 1),  # batch_size=1, sequence_length=total, input_size=1
             x0.view(1, 1, 1)          # num_layers=1, batch_size=1, hidden_size=1
            )
